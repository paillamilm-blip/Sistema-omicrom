...
![estado](https://img.shields.io/badge/Estado-MVP_55%25-00f5ff?style=for-the-badge)
![stack](https://img.shields.io/badge/Stack-React_+_Supabase-7c3aed?style=for-the-badge)
![pais](https://img.shields.io/badge/Origen-Chile_🇨🇱-fbbf24?style=for-the-badge)
...
flowchart TD
    ...
    C -->|Aprende| D[🎮 MaxSkill: árbol + retos<br/>↑ Fundamento]
    C -->|Valida CV| E[🎓 Credenciales<br/>↑ Tradicional]
    C -->|Estudia| F[📚 Academia: cursos]

    D --> G[💼 Busca / acepta trabajo]
    E --> G
    F --> G

    G --> H[🔒 Contrato + Escrow<br/>fondos bloqueados]
    H --> I[💬 Chat cifrado<br/>Caja Negra]
    I --> J[📦 Entrega + Ghost Approval<br/>15 min]
    J --> K{¿Aprobado?}

    K -->|Sí ✅| L[💰 Libera fondos<br/>+ Calificación ⭐<br/>↑ Ejecución ↑ Calidad]
    K -->|Objeta ⚠️| M[⚖️ Tribunal de Pares<br/>3 árbitros ciegos]

    L --> N[📈 Capitaliza en Bóveda<br/>↑ Trascendencia + Regalías]
    N --> O[🤝 Mentorías<br/>↑ Trascendencia]
    O --> P[⬆️ Sube de rango<br/>N1 → N2 → N3]
    P --> C
    M --> L
```
