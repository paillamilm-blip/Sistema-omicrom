...
| 🎨 **Identidad visual Industria 5.0** (azul + ámbar, sin morado) | ✅ |

---

## 🎨 5. IDENTIDAD VISUAL — INDUSTRIA 5.0

```
HÉROE:    azul eléctrico  #2e9bff
ACENTO:   ámbar energía    #ff9d2e
BASE:     acero oscuro     #06090f → #0a0f17
ESTADOS:  verde #2bd97c · rojo #ff5066
```
Regla: **1 héroe + 1 acento + neutros**. Sin arcoíris. Rejilla blueprint, esquineros HUD, glows.
...
```
Frontend:  React 18 + TypeScript + Vite + TailwindCSS + theme.ts (Industria 5.0)
