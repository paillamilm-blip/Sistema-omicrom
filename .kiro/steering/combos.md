# 🎯 COMBOS Y CADENAS — Sistema Ómicron

> Cuando el usuario diga el nombre de un combo o cadena, ejecutar automáticamente el flujo correspondiente.
...
## 10 CADENAS (paso a paso, uno por uno)
...
| 7 | 💡 **EXPLORAR** | Office hours → Superpowers → [usuario elige] → Hacelo → Ship it |
...
4. Si el usuario dice "Hacelo" sin contexto adicional, aplicar GSD (ejecución rápida sin preguntas).
5. "Hacelo con cuidado" = GSD + verificación extra antes de entregar.
6. "Superpowers" = análisis profundo, múltiples opciones, razonamiento visible.
