...
The search script ships inside this skill. Invoke it by its project-root-relative path, from the repository root:

```bash
python3 .kiro/skills/ui-ux-pro-max/scripts/search.py "<query>" --domain <domain>
```

If `python3` is not found, try `python`, then `py -3`. Requires Python 3.x, standard library only — no external dependencies and no network access.
...
```bash
python3 .kiro/skills/ui-ux-pro-max/scripts/search.py "<product_type> <industry> <keywords>" --design-system [-p "Project Name"]
```
...
**Example:**
```bash
python3 .kiro/skills/ui-ux-pro-max/scripts/search.py "beauty spa wellness service" --design-system -p "Serenity Spa"
```
...
```bash
python3 .kiro/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --persist -p "Project Name" --output-dir "<project-root>"
```
...
```bash
python3 .kiro/skills/ui-ux-pro-max/scripts/search.py "<query>" --design-system --variance <1-10> --motion <1-10> --density <1-10>
```
...
**Example:**
```bash
python3 .kiro/skills/ui-ux-pro-max/scripts/search.py "internal analytics dashboard" --design-system --variance 8 --motion 7 --density 8 -p "Ops Console"
```

### Step 3: Supplement with Detailed Searches (as needed)

```bash
python3 .kiro/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --domain <domain> [-n <max_results>]
```
...
```bash
python3 .kiro/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack <stack>
```
...
python3 .kiro/skills/ui-ux-pro-max/scripts/search.py "AI search tool modern minimal" --design-system -p "AI Search"

# Step 3: supplement
python3 .kiro/skills/ui-ux-pro-max/scripts/search.py "keyboard focus modal" --domain ux

# Step 4: stack guidelines
python3 .kiro/skills/ui-ux-pro-max/scripts/search.py "suspense streaming bundle" --stack nextjs
```
