...
2. Es un sistema **aditivo**: nada de lo actual cambia. Para usarlo: `import { Orb } from './components/Orb'` y los tokens desde `./design-system/tokens`.
3. Siguiente paso natural: cablear el orbe en Inicio/Academia/Perfil y construir la escena orbital de la Academia (nodos orbitando) con GSAP.
