            ...
            <div style={styles.advisorBody}>
              ...
              {matchResult && (
                <div style={styles.advisorResult}>
                  ...
                  <p style={{ margin: 0, fontFamily: FONT_RAJ, fontSize: 13, color: C.ink, lineHeight: 1.55, whiteSpace: 'pre-wrap' }}>{matchResult}</p>
                </div>
              )}
            </div>
          )}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  trustValSmall: { fontFamily: FONT_MONO, fontSize: 11, color: C.ink, lineHeight: 1.2 },
  trustDivider: { width: 1, height: 26, background: C.lineSoft, flexShrink: 0 },
  advisorWrap: { flexShrink: 0, borderRadius: 12, border: `1px solid rgba(255, 176, 46,0.35)`, background: 'linear-gradient(135deg, rgba(255, 176, 46,0.08), rgba(2,6,19,0.5))', overflow: 'hidden' },
  ...
  advisorHint: { margin: 0, fontFamily: FONT_MONO, fontSize: 11, color: C.muted, lineHeight: 1.45 },
