...
const styles: Record<string, React.CSSProperties> = {
  ...
  searchBox: { flex: 1, display: 'flex', alignItems: 'center', gap: 8, padding: '0 12px', borderRadius: 8, background: 'rgba(160,174,192,0.05)', border: `1px solid ${C.line}` },
  ...
  oracleResult: { padding: 12, borderRadius: 8, background: 'rgba(160,174,192,0.06)', border: `1px solid rgba(160,174,192,0.25)` },
  ...
  simBadge: { position: 'absolute', top: 12, right: 14, fontFamily: FM, fontSize: 8, color: C.blueHi, background: 'rgba(160,174,192,0.12)', border: `1px solid ${C.blue}`, padding: '2px 7px', borderRadius: 3 },
  ...
  modal: { width: '100%', maxWidth: 400, maxHeight: '85vh', overflowY: 'auto', borderRadius: 12, padding: 20, background: `linear-gradient(145deg, ${C.panelA}, ${C.panelB})`, border: `1px solid ${C.blue}`, boxShadow: '0 0 30px rgba(160,174,192,0.3)', position: 'relative' },
};
