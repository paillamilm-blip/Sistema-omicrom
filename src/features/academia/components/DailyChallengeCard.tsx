...
const S: Record<string, React.CSSProperties> = {
  card: {
    ...
    padding: '16px',
    borderRadius: 14,
    background: 'linear-gradient(145deg, rgba(160,174,192,0.06), rgba(94,92,230,0.04))',
  ...
  cta: {
    ...
    borderRadius: 8,
    border: 'none',
    background: 'linear-gradient(135deg, #a0aec0, #008b9e)',
    color: '#04121f',
    fontFamily: FONT.mono,
    fontSize: 11,
    fontWeight: 700,
    letterSpacing: 1,
    cursor: 'pointer',
    boxShadow: '0 0 14px rgba(160,174,192,0.3)',
  },
  cardDone: {
    margin: '0 0 14px',
    padding: '12px 14px',
