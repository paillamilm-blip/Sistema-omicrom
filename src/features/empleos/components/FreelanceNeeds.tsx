...
const S: Record<string, React.CSSProperties> = {
  ...
  filterChip: { flexShrink: 0, padding: '6px 11px', borderRadius: 6, border: '1px solid rgba(160,174,192,0.15)', background: 'transparent', color: C.mut, fontFamily: FONT.mono, fontSize: 9, cursor: 'pointer', whiteSpace: 'nowrap' },
  filterActive: { background: 'rgba(160,174,192,0.1)', borderColor: C.cyan, color: C.cyan },
  card: { position: 'relative', background: 'rgba(8,16,38,0.6)', border: `1px solid rgba(160,174,192,0.1)`, borderRadius: 14, padding: '14px', marginBottom: 12, overflow: 'hidden' },
  ...
  skillTag: { padding: '3px 8px', borderRadius: 4, background: 'rgba(160,174,192,0.06)', border: '1px solid rgba(160,174,192,0.15)', fontFamily: FONT.mono, fontSize: 9, color: '#c8ddf0' },
  ...
  inp: { width: '100%', boxSizing: 'border-box', background: 'rgba(160,174,192,0.04)', border: `1px solid ${C.line}`, borderRadius: 6, padding: '10px 12px', color: C.ink, fontFamily: FONT.mono, fontSize: 12, outline: 'none', marginBottom: 10 },
