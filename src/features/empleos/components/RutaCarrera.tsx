...
const EJE: Record<EjeKey, { label: string; study: string; tab: TabId; color: string }> = {
  execution:     { label: 'Ejecución',     study: 'Toma contratos cortos y retos para ganar velocidad de entrega.', tab: 'empleos',  color: '#a0aec0' },
...
export function RutaCarrera() {
  ...
  return (
    <div style={{ margin: '14px 0', padding: 16, borderRadius: RADIUS.xl, background: 'rgba(12,20,38,0.95)', border: '1px solid rgba(160,174,192,0.14)' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        {ranked.slice(0, 4).map((a) => {
          ...
          return (
            <div key={a.track.id} style={{ padding: '11px 13px', borderRadius: RADIUS.lg, background: 'rgba(160,174,192,0.05)', border: `1px solid ${C.cyanFaint}` }}>
