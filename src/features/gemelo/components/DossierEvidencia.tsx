  ...
  return (
    <div style={{
      ...
      {loading ? (
        ...
        <div style={{ textAlign: 'center', padding: '18px 12px', borderRadius: RADIUS.lg, background: 'rgba(160,174,192,0.04)', border: '1px dashed rgba(160,174,192,0.18)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
          {actas.map(a => {
            ...
            return (
              <div key={a.id} style={{ borderRadius: RADIUS.lg, padding: 12, background: 'rgba(160,174,192,0.04)', border: `1px solid ${ok ? 'rgba(63, 208, 201,0.30)' : 'rgba(255, 92, 122,0.30)'}` }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 8, marginBottom: a.resumen ? 8 : 0 }}>
                  {EJES.map(e => (
                    <div key={e.key} style={{ textAlign: 'center', padding: '5px 0', borderRadius: 6, background: 'rgba(160,174,192,0.05)' }}>
